...
Paper:
    Sener, O., & Koltun, V. (2018). Multi-task learning as multi-objective optimization. Advances in neural information
...
class MinNormSolver:
    ...
    def find_min_norm_element(vecs):
        ...
        It is quite geometric, and the main idea is the fact that if d_{ij} = min |u|_2 st u = c x_i + (1-c) x_j; the
        solution lies in (0, d_{i,j})
        ...
        # Return the best known solution, as in Algorithm 2 of the paper
        # noinspection PyUnboundLocalVariable
        return sol_vec, nd
