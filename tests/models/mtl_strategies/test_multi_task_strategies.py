...
def test_equal_weighting(in_features, loss, learning_rate, device_name):
    """Test of the EqualWeighting works for optimisation"""
    batch_size = 10
    num_dummy_epochs = 7
...
def test_equal_weighting_preserves_frozen_layers_and_updates_others(in_features, loss, learning_rate, device_name):
    """Test if EqualWeighting implementation preserves the frozen layers and updates the others"""
    batch_size = 10
    num_dummy_epochs = 30
